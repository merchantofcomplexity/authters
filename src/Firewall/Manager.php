...
use MerchantOfComplexity\Authters\Support\Firewall\FirewallContextResolver;
...
final class Manager
{
    ...
    public function __construct(Application $app, FirewallContextResolver $contextResolver, Processor $processor)
    {
        $this->app = $app;
    ...
    protected function prepareFirewall(string $name): FirewallAware
    {
        ...
        $context = $this->fromConfig("authentication.group.$name.context", null);
